...
def objective(trial):
    ...
    train_loader, val_loader, test_loader = load_dataloader(
        '../dataset/tanjiaoyi/dataloader/s-hb-dataloader.pth')
    ...
    _, _, _, r2 = compute_metrics(labels, preds)

    return r2  # 我们希望最大化 R2 分数


# 创建一个 Optuna 学习对象并开始优化
study = optuna.create_study(study_name='GCTCN-湖北-R2', direction="maximize",
